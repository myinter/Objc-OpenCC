...
*/
//#define OPENCC_DEFAULT_CONFIG_SIMP_TO_TRAD  [[[NSBundle mainBundle]pathForResource:@"s2t" ofType:@"json"]UTF8String]
...
* @ingroup opencc_c_api
*/
//#define OPENCC_DEFAULT_CONFIG_TRAD_TO_SIMP [[[NSBundle mainBundle]pathForResource:@"t2s" ofType:@"json"]UTF8String]
